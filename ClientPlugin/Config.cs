...
public class Config : INotifyPropertyChanged
{
    ...
    /// <summary>
    /// Compile-time march cap. Must match <c>AURORA_MAX_STEPS</c> in
    /// Pack/Fullscreen/AfterAtmosphere/AuroraBorealis.hlsl so High is not
    /// silently truncated.
    /// </summary>
    public const int MaxRaymarchSteps = 96;
